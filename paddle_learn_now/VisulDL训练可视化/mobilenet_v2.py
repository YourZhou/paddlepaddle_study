# 用Depthwise Convolutions代替残差单元的bottleneck，
# 最重要的是与residuals block相反，
# 通常的residuals block是先经过1×1的卷积，
# 降低feature map通道数，然后再通过3×3卷积，
# 最后重新经过1×1卷积将feature map通道数扩张回去；
# 而且为了避免ReLU对特征的破坏，
# 用线性层替换channel数较少层后的ReLU非线性激活。
