...
# 开始训练模型，在训练过程中，
# 把训练时的损失值保存到train_cost_writer中，
# 把训练时的准确率保存到train_acc_writer中，
# 把训练过程中的参数变化保存到histogram中。
# 把测试时的损失值保存到test_cost_writer中，
# 把测试时的准确率保存到test_acc_writer中。
